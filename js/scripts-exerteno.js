...
function exibeMetodologias(metodologia) {
    if (metodologia.value == "jj_adulto") {
        ...
        document.querySelector('.metodologia_feminino').style.display = "none";

    } else if (metodologia.value == "jj_feminino") {
        document.querySelector('.metodologia_feminino').style.display = "block";
        document.querySelector('.metodologia_infantil').style.display = "none";
